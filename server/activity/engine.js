...
function normalizeItem(raw) {
    ...
    return {
        ...
        duration: Number(s.duration ?? raw.duration ?? 0),
        progress: Number(s.timeOffset ?? raw.progress ?? 0),
        watched: Number(s.flaggedWatched ?? s.watched ?? raw.watched ?? 0),
        timesWatched: Number(s.timesWatched ?? raw.timesWatched ?? 0),
        timeOffset: Number(s.timeOffset ?? raw.timeOffset ?? 0),
        overallTimeWatched: Number(s.overallTimeWatched ?? raw.overallTimeWatched ?? 0),
        timeWatched: Number(s.timeWatched ?? raw.timeWatched ?? 0),
